"use client";
import { Calendar, User, Wallet, Wallet2 } from "lucide-react";
import {
  useMotionValueEvent,
  useScroll,
  useTransform,
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          Your Trip Journey from <strong className="text-primary">{tripData?.origin}</strong> to <strong className="text-primary">{tripData?.destination}</strong>
        </h2>
