  ...
  return (
    <div className='mt-24 flex items-center justify-center'>
      <div className='max-w-3xl w-full text-center '>
        ...
        <p className='text-lg'>Tell me what you want, and I'll help you plan your perfect trip!</p>
        <div>
        ...
        <div className='flex gap-5'>
          {suggestions.map((suggestion, index) => {
            return (
              <div key={index} className='flex items-center gap-2 p-2 border rounded-full cursor-pointer hover:bg-primary hover:text-white transition-all'>
                {suggestion.icon}
